...
import { drawWeeklyEventImage, getWeekRange } from "../image/drawWeeklyEventImage";
...
export function scheduleWeeklyEventsEmail() {
  // ┌──────── minute (0)
  // │ ┌────── hour (6)
  // │ │ ┌──── day of month (*)
  // │ │ │ ┌── month (*)
  ...
  cron.schedule("0 6 * * 1", () => {
    runWeeklyEventsEmail().catch(console.error);
  });
}
